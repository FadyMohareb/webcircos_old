...
//            }
            ...
            console.log(self.HEATMAP + " HEATMAP AFTER REGTEST");
            self.SNP = new Array();
...
//            }
    ...
    BioCircos.prototype.chromview = function (genome, d) {
                        ...
                        var labelInit = self.genomeLabel[d.index];
                        ...
                        if (self.ARC.length > 0) {
                            for (var arci = 0; arci < self.ARC.length; arci++) {
                                ...
                                console.log(ChromArc);
                                console.log(ChromArc.length);

                                var arc_objects = BioCircosArc(SingleChord.groups());
                                console.log(arc_objects.length);
                                console.log(arc_objects);
                                console.log(arc_objects[0].endAngle);
                                console.log(arc_objects[0].arc_chr);

                                var arc_p = (d.endAngle - d.startAngle) / d.value;
                                console.log(arc_p);
                      ...
                      console.log("finished ARC");  }
                        ...
                        //now for Diff Expression
                        console.log(self.HEATMAP + " Content of Heatmap");
                        if (self.HEATMAP.length > 0) {
                            ...
                            for (var heatmapi = 0; heatmapi < self.HEATMAP.length; heatmapi++) {
                                ...
                                console.log(self.HEATMAP);
                                console.log(self.HEATMAP.length);
                                var reg = new RegExp(self.genomeLabel[d.index]);
                                console.log(reg);
                                console.log(self.HEATMAP[0][1].chr);
                                console.log(self.HEATMAP[1][1].chr);
                       ...
                       if (self.LINE.length > 0) {
                        ...
                        for (var linei = 0; linei < self.LINE.length; linei++) {
                            ...
                            self.init_LINEsettings();
                            function BioCircosLINE(d) {
                                return ChromLine[linei].map(function (v, i) {
                        ...
                        if (self.BACKGROUND.length > 0) {
                            for (var backgroundi = 0; backgroundi < self.BACKGROUND.length; backgroundi++) {
                                ...
                                svg.append("g")
                                        .attr("class", "BioCircosBackGround")
                                        .selectAll("path")
                                        .data(SingleChord.groups)
                                        .enter().append("path")
                                        .style("fill", "#F2F2F2")
    ...
    BioCircos.prototype.BSA = function (genome, n) {
        ...
        console.log(self.LINK);     
                                        ...
                                        console.log(GenomeLableMulitplier(self.genomeLabel, n));
                                        console.log(self.genomeLength);
                                        console.log(self.initGenome);
                                        console.log(GenomeMultiplier(self.genomeLength, 4))
