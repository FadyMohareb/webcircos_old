...
var FilesPanel = React.createClass({displayName: "FilesPanel",
    getInitialState: function getInitialState() {
        return {view: { showUploadModal: false, showImportModal: false } };
    },
    ...
    render: function () {
        ...
        React.createElement('div', {className: "panel-body", id: 'filesTabsContainer'},
                ...
                this.state.view.showImportModal ? React.createElement(ImportModalTest, {handleHideUploadModal: this.handleHideImportModal, projectName: this.props.projectName}) : null));
    }
});
