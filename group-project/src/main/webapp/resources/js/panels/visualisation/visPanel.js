        ...
        return (
                React.createElement("div", {style: {width: $('#centerContainer').width(), float: "right"}, id: 'centerTabs'},
                        React.createElement("ul", {className: "nav nav-pills"},
                                ...
                                React.createElement('li', {style: {float: 'right'}}, React.createElement('a', {href: "resources/webcircos-user-manual.pdf", download: "webcircos-user-manual.pdf"}, React.createElement('strong', null, "User manual")))),
