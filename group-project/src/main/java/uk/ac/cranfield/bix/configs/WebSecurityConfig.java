    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                    ...
                    .antMatchers("/resources/**","/recognizeFileName","/recognizeFileType", "/registrationReact", "/loginReact", "/import/getAll","/loginReactAction", "/import/copyFile", "/manageAccount", "/home", "/controller/upload", "/refresh", "/circos.data").permitAll()
